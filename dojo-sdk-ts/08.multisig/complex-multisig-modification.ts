...
const accountL0M = facade.createAccount(PrivateKey.random());

// --------

const accountL1M1 = facade.createAccount(PrivateKey.random());

const accountL1M2 = facade.createAccount(PrivateKey.random());

const privateKeyL1C1 = PrivateKey.random();
const accountL1C1 = facade.createAccount(privateKeyL1C1);
fs.writeFileSync("accountL1C1.key", accountL1C1.toString(), "utf8");

// --------

const accountL2M1 = facade.createAccount(PrivateKey.random());

const privateKeyL2C1 = PrivateKey.random();
const accountL2C1 = facade.createAccount(privateKeyL2C1);
fs.writeFileSync("accountL2C1.key", accountL2C1.toString(), "utf8");

const privateKeyL2C2 = PrivateKey.random();
const accountL2C2 = facade.createAccount(privateKeyL2C2);
fs.writeFileSync("accountL2C2.key", accountL2C2.toString(), "utf8");

// --------

const privateKeyL2C3 = PrivateKey.random();
const accountL2C3 = facade.createAccount(privateKeyL2C3);
fs.writeFileSync("accountL2C3.key", accountL2C3.toString(), "utf8");

const privateKeyL2C4 = PrivateKey.random();
const accountL2C4 = facade.createAccount(privateKeyL2C4);
fs.writeFileSync("accountL2C4.key", accountL2C4.toString(), "utf8");

// --------

const privateKeyL3C1 = PrivateKey.random();
const accountL3C1 = facade.createAccount(privateKeyL3C1);
fs.writeFileSync("accountL3C1.key", accountL3C1.toString(), "utf8");
...
const descriptor = new descriptors.AggregateCompleteTransactionV2Descriptor(
  facade.static.hashEmbeddedTransactions(aggregatedTransactions),
