...
const coSign1 = accountM.cosignTransaction(transaction, false);
const coSign2 = account2.cosignTransaction(transaction, false);
transaction.cosignatures.push(coSign1);
transaction.cosignatures.push(coSign2);
...
const coSign1a = account1.cosignTransactionHash(facade.hashTransaction(transaction), true);
const account1CosignJsonPayload = JSON.stringify(coSign1a.toJson());
