...
import { SymbolFacade, descriptors, models, generateMosaicId, generateNamespaceId, generateNamespacePath } from 'symbol-sdk/symbol';
...
const descriptor1 = new descriptors.NamespaceRegistrationTransactionV1Descriptor(
  ...
  models.NamespaceRegistrationType.ROOT, // ネームスペース登録タイプ
  new models.BlockDuration(BigInt(rentalBlocks)), // レンタル期間
...
const descriptor5 = new descriptors.MosaicAliasTransactionV1Descriptor(
  namespaceId,
  mosaicId,
